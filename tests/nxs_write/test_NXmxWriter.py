...
@patch("nexgen.nxs_write.nx_mx_writer.write_NXsample")
@patch("nexgen.nxs_write.nx_mx_writer.write_NXsource")
@patch("nexgen.nxs_write.nx_mx_writer.write_NXdetector_module")
@patch("nexgen.nxs_write.nx_mx_writer.write_NXdetector")
@patch("nexgen.nxs_write.nx_mx_writer.write_NXinstrument")
@patch("nexgen.nxs_write.nx_mx_writer.write_NXdata")
@patch("nexgen.nxs_write.nx_mx_writer.write_NXentry")
...
@patch("nexgen.nxs_write.nx_mx_writer.write_NXdatetime")
...
@patch("nexgen.nxs_write.nx_mx_writer.write_NXnote")
...
@patch("nexgen.nxs_write.nx_mx_writer.image_vds_writer")
