...
# All of this should be in a CLI/ in separate small utility functions
# And here just something like the above but for non-serial
# Which means, same for tristan, no N-frames/vds for eiger.
# FIXME
# def nexus_writer(
#     meta_file: Path | str,
#     detector_name: str,
